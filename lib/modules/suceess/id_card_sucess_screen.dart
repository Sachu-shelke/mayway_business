...
class IdCardSucessScreen extends StatefulWidget {
  const IdCardSucessScreen({super.key});

  @override
  State<IdCardSucessScreen> createState() => _IdCardSucessScreenState();
}

class _IdCardSucessScreenState extends State<IdCardSucessScreen> {
  double? height;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {},
                      child: Text(
                        'Your Id Card Purchase Request Sent Successfully',
