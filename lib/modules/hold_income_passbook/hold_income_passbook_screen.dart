...
import 'package:mayway_business/modules/hold_income_passbook/hold_income_passbook_presenter.dart';
...
class HoldIncomePassbookScreen extends StatefulWidget {
  final bool isFromDrawer;
  final String? filter;
  const HoldIncomePassbookScreen(
      {super.key, this.filter, required this.isFromDrawer});

  @override
  State<HoldIncomePassbookScreen> createState() =>
      _HoldIncomePassbookScreenState();
}

class _HoldIncomePassbookScreenState extends State<HoldIncomePassbookScreen>
    implements HoldIncomePassbookView {
  HoldIncomePassbookPresenter presenter = BasicHoldIncomePassbookPresenter();
  ...
  @override
  void refreshModel(HoldIncomePassbookModel incomePassbookModel) {
  ...
  Future<void> _refreshIndicator() async {
    presenter.getIncomePassbook(
        isForHoldIncome: true, page: page, context: context);
  }
